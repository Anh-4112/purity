  ...
  loadMorePosts(target) {
      ...
      fetch(`${loadMore_url}`)
          ...
          .then(responseText => {
              ...
              const resultNodesHtml = resultNodes.querySelectorAll('#main-items .item-load');
              resultNodesHtml.forEach(prodNode => document.getElementById("section__content-items").appendChild(prodNode));
